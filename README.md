...
flowchart TD
    ...
    D2 --> E
    E --> F["📊 Analytics Agent"]:::agent
    F --> G["⚠️ Risk Agent"]:::agent
    G --> H["🎯 Decision Optimization Agent"]:::agent
    H --> I["🔮 What-if Analysis"]:::process
    I --> J["✅ Recommended Action"]:::output
    J --> K["🙋 Final User Decision"]:::output
...
flowchart TD
    ...
    WI --> DASH["📋 Final Dashboard"]:::output
    BR --> DASH
...
When data is inadequate, EVORA is designed to return *"Insufficient evidence for a strong recommendation"* rather than guess.
